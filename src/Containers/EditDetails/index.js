...
const ProductScreen = () => {
  ...
  const FetchData = async () => {
    ...
    await axios
      .post(
        'http://192.168.1.8:8080/users/getuserbyid',
        {
          _id: user._id,
        },
        config,
  ...
  const UpdateItem = async () => {
    ...
    const data = await axios.patch(
      'http://192.168.1.8:8080/item/update',
      {
        name: name,
        contactPhone: phone,
        contactEmail: email,
    ...
    try {
      axios
        .post('http://192.168.1.8:8080/item/mainimage', mainform, config)
        .then(res => {
      ...
      await axios
        .post('http://192.168.1.8:8080/item/imageupload', Gallary, config)
        .then(result => {
          console.log(reslut)
        })
        .catch(e => {
      ...
      if (Brochure) {
        ...
        await axios
          .post(
            'http://192.168.1.8:8080/item/uploadbrochure',
            brocherdata,
            config,
          )
          .then(result => {
  ...
  const uploadAlbums = async (id, item, config) => {
    ...
    await axios
      .post('http://192.168.1.8:8080/item/uploadalbum', data, config)
      .then(result => {
        console.log(result)
      })
      .catch(e => {
